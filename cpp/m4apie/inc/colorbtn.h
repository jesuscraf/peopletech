...
public:
	...
	//##ModelId=396B32960318
	static COLORREF colors[20];
	//##ModelId=396B3296030E
    static BYTE used[20];

	//##ModelId=396B32960306
    CButton *parent;
	//##ModelId=396B329602FB
    int colorindex;

	//##ModelId=396B32960368
...
protected:
	...
	//##ModelId=396B32960354
	virtual BOOL OnInitDialog();
	//##ModelId=396B3296034A
	afx_msg void OnLButtonDown(UINT nFlags, CPoint point);
	//##ModelId=396B32960339
	afx_msg void OnDrawItem(int nIDCtl, LPDRAWITEMSTRUCT lpd);
	//##ModelId=396B32960337
	afx_msg void OnOther();
	//##ModelId=396B3296032C
	afx_msg void OnLButtonUp(UINT nFlags, CPoint point);
	//}}AFX_MSG

	//##ModelId=396B32960323
	void OnColor(UINT id);    
	//##ModelId=396B32960319
