...
// Definition:
//
//    En este módulo se declara el objeto para representar los tags de los totales
//
//
//==============================================================================
...
#ifndef __CLTTOTALTAG_HPP__
#define __CLTTOTALTAG_HPP__
...
// ClTempTotalTag
//
// Clase que implementa la definición de los tag de totales
//
//=================================================================================

class	ClTempTotalTag : public ClSlicedElement
{

protected:

	m4char_t		m_acTagId		[ M4CL_MAX_TOTAL_TAG_ID + 2 ] ;
...
// Funciones de escritura =====================================================
	...
	{
		return( M4MdFacSetLocalId( ai_pccTagId, m_acTagId, M4CL_MAX_TOTAL_TAG_ID, ai_bConvert ) ) ;
	}
