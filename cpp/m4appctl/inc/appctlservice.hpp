#ifndef _APPCTLSERVICE_H_
#define _APPCTLSERVICE_H_
...
#define SZSERVICENAME        "M4appctl" //LAJ cambiar
// Nombre que se mostrará del servicio
#define SZSERVICEDISPLAYNAME "Meta4 Application Server Controller" //LAJ cambiar
