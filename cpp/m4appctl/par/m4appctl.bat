...
:: @(#) FileDescription: Windows Startup script for Meta4 Application Controler .
...
set M4_APP_CONFIG_FILE=%M4_APP_CONF%\m4appctl.conf
set M4_APP_EXE=%M4_APP_BIN%\%M4_RUN_MODE%\m4appctl.exe 
