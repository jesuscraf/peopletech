...
#ifndef __CCOMCOLLECTION_H__
#define __CCOMCOLLECTION_H__


template<class TYPE, class BASE> 
class CMyCollection : public BASE
{
public:
	struct CMinNode
	{
...
template<class TYPE, class BASE>
STDMETHODIMP CMyCollection<TYPE,BASE>::Add(TYPE *pIType, VARIANT index)
{
...
template<class TYPE, class BASE>
STDMETHODIMP CMyCollection<TYPE,BASE>::get_Count(long *pVal)
{ 
    HRESULT hr = S_OK;
    if (pVal != NULL)
    {
...
template<class TYPE, class BASE>
STDMETHODIMP CMyCollection<TYPE,BASE>::RemoveAll()
{
    HRESULT hr = E_FAIL;
...
template<class TYPE, class BASE>
STDMETHODIMP CMyCollection<TYPE,BASE>::get_Item(VARIANT index, TYPE **pvar)
{
    HRESULT hr = S_OK;
    if (pvar != NULL)
    {
...
template<class TYPE, class BASE>
STDMETHODIMP CMyCollection<TYPE,BASE>::get__NewEnum(LPUNKNOWN *ppVal)
{
    HRESULT hr = S_OK;
...
template<class TYPE, class BASE>
STDMETHODIMP CMyCollection<TYPE,BASE>::Remove(VARIANT index)
{
    HRESULT hr = S_OK;
...
template<class TYPE, class BASE>
TYPE* CMyCollection<TYPE,BASE>::Item(long lIndex)
{ 
    TYPE* pType=NULL;
...
template<class TYPE, class BASE>
TYPE* CMyCollection<TYPE,BASE>::Item(BSTR bstrKey)
{ 
    TYPE* pType=NULL;
...
template<class TYPE, class BASE>
typename CMyCollection<TYPE,BASE>::CMinNode* CMyCollection<TYPE,BASE>::GetNode(long lIndex)
{ 
    CMinNode* pNode=NULL;
    long lCounter=1;
...
template<class TYPE, class BASE>
typename CMyCollection<TYPE,BASE>::CMinNode* CMyCollection<TYPE,BASE>::GetNode(BSTR bstrKey)
{ 
    CMinNode *pNode=NULL;

    pNode = m_pNodeHead;
	while (pNode != NULL && (pNode->bstrKey == NULL || (wcscmp(bstrKey, pNode->bstrKey) != 0) ))
    {
		pNode = pNode->pNext;
    }
...
template<class TYPE, class BASE>
long CMyCollection<TYPE,BASE>::AddTail(TYPE *pIType, BSTR bstrKey)
{
...
template<class TYPE, class BASE>
bool CMyCollection<TYPE,BASE>::InnerRemoveAll()
{
	// destroy elements
    bool fRet = true;
    VARIANT var;
...
template<class TYPE, class BASE>
typename CMyCollection<TYPE,BASE>::CMinNode* CMyCollection<TYPE,BASE>::NewMinNode(
	typename CMyCollection<TYPE,BASE>::CMinNode* pPrev,
	typename CMyCollection<TYPE,BASE>::CMinNode* pNext)
{
    CMyCollection<TYPE,BASE>::CMinNode* pNode = new CMyCollection<TYPE,BASE>::CMinNode;
	pNode->pPrev = pPrev;
	pNode->pNext = pNext;
    pNode->pData = NULL;
    pNode->bstrKey = NULL;
...
template<class TYPE, class BASE>
void CMyCollection<TYPE,BASE>::FreeMinNode(typename CMyCollection<TYPE,BASE>::CMinNode* pNode)
{
...
template<class TYPE, class BASE>
STDMETHODIMP CMyCollection<TYPE,BASE>::get_Key(VARIANT vIndex, BSTR * bstrVal)
{
...
template<class TYPE, class BASE>
STDMETHODIMP CMyCollection<TYPE,BASE>::put_Key(VARIANT vIndex, BSTR bstrnewVal)
{
	CMinNode *pNode = GetNode(vIndex);
	if (pNode != NULL)
	{
...
template<class TYPE, class BASE>
typename CMyCollection<TYPE,BASE>::CMinNode* CMyCollection<TYPE,BASE>::GetNode(VARIANT vIndex)
{
